...
def visualize(image, recon_combined, recons, masks, attns=None, pos_pred=None, pos_pred_loc=None, num_vis=4, colored_box=True):
    '''
        `image`: [B, 3, H, W]
...
def visualize_attns(image, recon_combined, recons, pred_masks, gt_masks=None, attns=None, attns_origin=None, 
                    pos_pred=None, pos_pred_loc=None, colored_box=True):
    '''
        `image`: [B, 3, H, W]
        `recon_combined`: [B, 3, H, W]
        `recons`: [B, K, H, W, C]
